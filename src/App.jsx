    ...
    <>
      ...
      <div className="container bg-blue-200 min-h-[80vh] w-[78%] m-auto my-3 rounded-lg">
        ...
        <div className="addTodo p-5 w-full  bg-blue-300">
          ...
          <button className='bg-blue-800 text-white font-bold p-2 px-3 hover:bg-blue-700 cursor-pointer rounded-md mx-3'>Save</button>
        </div>
        ...
        <div className="myTodos">
          ...
          <div className="showOption flex gap-3 mt-1 mx-3 text-lg items-center">
